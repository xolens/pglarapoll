...
use Xolens\PgLarapoll\App\Model\View\UserGroupView;
use Xolens\LarapollContract\App\Contract\Repository\View\UserGroupViewRepositoryContract;
use Xolens\PgLarautil\App\Repository\AbstractReadableRepository;
use Xolens\LarautilContract\App\Util\Model\Filterer;
use Xolens\LarautilContract\App\Util\Model\Sorter;

class UserGroupViewRepository extends AbstractReadableRepository implements UserGroupViewRepositoryContract
{
    public function model(){
        return UserGroupView::class;
    }
     public function paginateByGroup($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(Xolens\PgLarapoll\App\Model\UserGroup::GROUP_PROPERTY, $parentId);
     ...
     public function paginateByUser($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(Xolens\PgLarapoll\App\Model\UserGroup::USER_PROPERTY, $parentId);
        return $this->paginateFiltered($parentFilterer, $perPage, $page,  $columns, $pageName);
     }
