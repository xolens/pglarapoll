...
use Xolens\PgLarapoll\App\Model\View\UserInvestigationView;
use Xolens\PollContract\App\Contract\Repository\View\UserInvestigationViewRepositoryContract;
use Xolens\PgLarautil\App\Repository\AbstractReadableRepository;
use Xolens\LarautilContract\App\Util\Model\Filterer;
use Xolens\LarautilContract\App\Util\Model\Sorter;

class UserInvestigationViewRepository extends AbstractReadableRepository implements UserInvestigationViewRepositoryContract
{
    public function model(){
        return UserInvestigationView::class;
    }
     public function paginateByUser($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(UserInvestigation::USER_PROPERTY, $parentId);
     ...
     public function paginateByInvestigation($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(UserInvestigation::INVESTIGATION_PROPERTY, $parentId);
        return $this->paginateFiltered($parentFilterer, $perPage, $page,  $columns, $pageName);
     }
